...
#define pop_Exception_stack pthread_setspecific(Exception_stack, (static_cast<Exception_Frame*>(pthread_getspecific(Exception_stack)))->prev)
/** @endcond */
...
#define TRY do { \
	volatile int Exception_flag; \
        ...
        Exception_frame.prev = static_cast<Exception_Frame*>(pthread_getspecific(Exception_stack)); \
